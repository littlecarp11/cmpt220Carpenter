...
public class thirteen9cont2 extends thirteen9cont {
    ...
    public String MyRectangle2D(double centerX, double centerY, double width, double height) {
    ...
    public String MyRectangle2D(MyPoint centerPoint, double width, double height) {
